...
$wpv_title = sprintf( __( 'Search Results for: %s', 'honeymoon' ), '<span>' . get_search_query() . '</span>' );
...
<div class="row page-wrapper">
	...
	<?php else: ?>
	<article>
		<h1 style="text-align: center;margin-top: 35px;"><?php _e('Sorry, nothing found', 'honeymoon') ?></h1>
	</article>
	<?php endif ?>
</div>
