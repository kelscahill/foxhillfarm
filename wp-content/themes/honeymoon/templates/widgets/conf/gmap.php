...
<p>
	<label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'honeymoon'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>" type="text" value="<?php echo $address; ?>" />
	<small><?php _e('Choose either an address or latitute and logtitude', 'honeymoon')?></small>
</p>
		
<p>
	<label for="<?php echo $this->get_field_id('latitude'); ?>"><?php _e('Latitude:', 'honeymoon'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('longitude'); ?>"><?php _e('Longitude:', 'honeymoon'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('zoom'); ?>"><?php _e('Zoom level:', 'honeymoon'); ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('html'); ?>"><?php _e('Content for the marker:', 'honeymoon'); ?></label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id('popup'); ?>"><?php _e('Auto popup the info?', 'honeymoon'); ?></label>
</p>
		
<p>
	<label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:', 'honeymoon'); ?></label>
