					...
					<div class="clearfix">
						<div class="post_extra_info nothumb">
							<<?php echo $title_tag?> class="title">
								<a href="<?php echo $c->comment_author_url ?>" rel="nofollow"><?php echo $c->comment_author ?></a> <?php _e('on', 'honeymoon') ?> <a href="<?php echo get_permalink($post->ID) ?>"><?php echo $post->post_title ?></a>
							</<?php echo $title_tag?>>
						</div>
					</div>
				</li>
