				...
				<span class="meta">
					<div class="more-button">
						<?php if(!empty($moreText)): ?>
							<a class="vamtam-button accent1 hover-accent2 <?php echo $lightbox?> <?php echo $type?>" <?php if(isset($link_target)) echo 'target="'.$link_target.'"'; ?> href="<?php echo $href?>" <?php echo $rel.$width.$height.$iframe?>>
								<?php echo $moreText ?>
							</a>
						<?php else: ?>
							<a class="<?php echo $lightbox?> <?php echo $type?>" <?php if(isset($link_target)) echo 'target="'.$link_target.'"'; ?> href="<?php echo $href?>" <?php echo $rel.$width.$height.$iframe?>>
								<?php echo wpv_shortcode_icon( array( 'name' => 'theme-circle-search' ) ) ?>
							</a>
						<?php endif ?>
					</div>
				</span>
