<?php
	...
	$button = isset($value['button']) ? $value['button'] : __('Insert', 'honeymoon');
	$remove = isset($value['remove']) ? $value['remove'] : __('Remove', 'honeymoon');
...
<div class="upload-basic-wrapper <?php echo !empty($default)?'active':'' ?>">
	<div class="image-upload-controls <?php if($video) echo 'wpv-video-upload-controls' ?>">
		...
		<a class="wpv-upload-undo hidden" href="#" data-target="<?php echo $id?>"><?php echo __('Undo', 'honeymoon')?></a>
	</div>
