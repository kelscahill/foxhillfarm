						...
						<div class="options">
							...
							<div>
								<label <?php if($width == 'full'):?>style="display:none"<?php endif?>>
									<input type="checkbox" name="<?php echo "$id_prefix-$i-last"?>" id="<?php echo "$id_prefix-$i-last"?>" value="true" class="<?php wpv_static($value)?>" <?php checked($is_last, true) ?> />&nbsp;<?php _e('last?', 'honeymoon') ?>
								</label>
								<label>
									<input type="checkbox" name="<?php echo "$id_prefix-$i-empty"?>" id="<?php echo "$id_prefix-$i-empty"?>" value="true" class="<?php wpv_static($value)?>" <?php checked($is_empty, true) ?> />&nbsp;<?php _e('empty?', 'honeymoon') ?>
								</label>
							</div>
						</div>
					</div>
